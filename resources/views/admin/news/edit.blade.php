...
@section('content')
    ...
    <div class="offset-2 col-8">
        <form class="form-group" method="post" action="{{ route('admin.news.update', ['news' => $news]) }}" enctype="multipart/form-data">
            @csrf
            @method('put')
            ...
            <div class="form-group mb-3">
                ...
                <input type="text" class="form-control" name="image_link" id="image_link"placeholder="Ссылка на изображение"
                       value="{{ $news->image }}">
